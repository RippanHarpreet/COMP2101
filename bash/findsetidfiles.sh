...
echo " biggest file of  my comp:"
echo " ==========="
# i have to  figure out how to generat the list of the 12 biggest files and put those commands
find / -type f -printf "%u %s %p \n" 2>/dev/null | sort -k 2 -n | tail -12 | awk '{print NR ":" $1,$2,$3}'
echo ""
